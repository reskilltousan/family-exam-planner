      ...
      <main className="mx-auto flex max-w-4xl flex-col gap-4 px-6 py-8">
          ...
          <Card>
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <div className="text-xs text-zinc-500">作成後にトップへ戻ります</div>
              </div>
            </div>
            <div className="space-y-3 pt-3">
              ...
              <button
                ...
                disabled={loading}
                className="flex items-center justify-center gap-2 rounded-full bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:opacity-90 disabled:opacity-60"
              >
          ...
          <Card>
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <div className="text-xs text-zinc-500">既存familyにサインイン</div>
              </div>
            </div>
            <div className="space-y-3 pt-3">
              <input
        ...
        <Card>
          ...
          <button
            ...
            disabled={loading}
            className="mt-3 rounded-full bg-emerald-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:opacity-90 disabled:opacity-60"
          >
            Cookieを読み込む
          </button>
        </Card>
